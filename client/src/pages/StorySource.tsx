...
export default function StorySource() {
  ...
  return (
    <article>
      <Seo title={`${source.publisher} — source record`} description={`CasinoVerse internal provenance record for ${source.sourceTitle}.`} path={`/sources/story/${source.id}`} />
