...
import { Cookie, FileCheck2, MessageSquareText, Scale, ShieldCheck } from "lucide-react";
...
const pages: Record<string, { title: string; eyebrow: string; description: string; icon: typeof Scale; sections: LegalSection[] }> = {
  privacy: {
    ...
    description: "How CasinooVerse handles cookie choices, consent-gated analytics, newsletter email addresses, infrastructure records, and privacy requests.",
    sections: [
      { title: "What CasinooVerse collects", paragraphs: ["CasinooVerse can be read without creating an account. We collect a newsletter email address only when a visitor submits the subscription form and affirmatively agrees to receive the editorial briefing.", "The subscription record stores the normalized email address, active or unsubscribed status, consent time, signup source, and normal database audit timestamps. It does not store a wagering profile, casino account, payment method, or gambling activity." ] },
      { title: "Analytics and cookie choice", paragraphs: ["Audience analytics is non-essential and does not load until a visitor selects Accept analytics in the cookie panel. Choosing Essential only stores the preference locally and prevents the analytics script from loading."], items: ["The consent choice is saved in the browser so the banner does not reappear on every page.", "Cookie settings can be reopened from the footer.", "CasinooVerse does not use the consent panel to authorize advertising cookies or gambling-affiliate tracking."] },
  ...
  disclaimer: {
    ...
    description: "CasinooVerse is an informational publication based in Sikkim, India, not a casino, wagering service, financial adviser, legal adviser, or treatment provider.",
    sections: [
      { title: "Informational publication only", paragraphs: ["CasinooVerse publishes research, history, game education, culture, destination context, regulation, and responsible-entertainment information. It does not accept wagers, deposits, withdrawals, bets, or payments for gaming and does not operate real-money games." ] },
      ...
      { title: "Internal source records", paragraphs: ["Evidence links open CasinooVerse-owned source records on this domain. Each record stores publisher identity, publication context, dates, source type, and the original address as non-clickable provenance text. Listing a source does not mean that institution endorses CasinooVerse or every conclusion in our reporting." ] },
      { title: "Accuracy and developing stories", paragraphs: ["CasinooVerse aims to distinguish confirmed facts, forecasts, proposals, company statements, and unresolved legal developments. A developing edition may change as the reporting window closes. Corrections and material updates are handled under the editorial standards." ] },
      { title: "Responsible entertainment", paragraphs: ["Gambling involves financial and psychological risk and is age-restricted. If participation causes harm, stop and seek local support. CasinooVerse’s safety page provides public resources but is not an emergency service." ] },
    ],
  },
  terms: {
    title: "Terms of Use", eyebrow: "Using CasinooVerse", icon: FileCheck2,
    description: "Terms governing access to CasinooVerse articles, research archives, newsletter signup, internal source records, and publication-owned material.",
    sections: [
      { title: "Acceptance and scope", paragraphs: ["By using CasinooVerse, you agree to use the service lawfully and consistently with these terms. If you do not agree, do not use the site or submit a newsletter address." ] },
      ...
      { title: "Editorial material and intellectual property", paragraphs: ["CasinooVerse’s original writing, layout, branding, generated editorial illustrations, and compiled research presentation are protected by applicable rights. Underlying facts and third-party source material recorded for provenance remain subject to their own rights and terms." ] },
      { title: "Newsletter", paragraphs: ["Submitting the newsletter form requires an accurate email address and affirmative consent. CasinooVerse may suspend duplicate, abusive, automated, or invalid subscriptions. No promise is made about delivery frequency until an email-delivery service is separately launched." ] },
      { title: "Availability and changes", paragraphs: ["Pages, archives, source records, data, and features may change, be corrected, be archived, or become temporarily unavailable. CasinooVerse does not guarantee uninterrupted access or that an original publisher address stored for provenance will remain current." ] },
      ...
      { title: "Contact and governing context", paragraphs: ["CasinooVerse identifies Sikkim, India as its regional publication location. Questions about these terms or editorial corrections may be submitted through the consent-aware contact form on the About page. Applicable legal rights may vary by location; these terms do not remove rights that cannot lawfully be waived." ] },
    ],
  },
};
