...
const pages: Record<string, { title: string; eyebrow: string; description: string; icon: typeof Scale; sections: LegalSection[] }> = {
  ...
  disclaimer: {
    ...
    sections: [
      ...
      { title: "Internal source records", paragraphs: ["Evidence links open CasinoVerse-owned source records on this domain. Each record stores publisher identity, publication context, dates, source type, and the original address as non-clickable provenance text. Listing a source does not mean that institution endorses CasinoVerse or every conclusion in our reporting." ] },
  ...
  terms: {
    ...
    description: "Terms governing access to CasinoVerse articles, research archives, newsletter signup, internal source records, and publication-owned material.",
    sections: [
      ...
      { title: "Availability and changes", paragraphs: ["Pages, archives, source records, data, and features may change, be corrected, be archived, or become temporarily unavailable. CasinoVerse does not guarantee uninterrupted access or that an original publisher address stored for provenance will remain current." ] },
