  ...
  return (
    <>
      ...
      <article>
        ...
        <section className="section-pad bg-felt-deep"><div className="container grid gap-10 lg:grid-cols-[1fr_360px] lg:items-end"><div><p className="eyebrow text-gold">Verified modern record</p><h2 className="mt-3 max-w-4xl font-display text-5xl leading-tight text-ivory md:text-6xl">Every year from 2010 to 3 September 2026.</h2><p className="mt-6 max-w-3xl text-lg leading-8 text-ivory/62">The project-owned archive adds one independently checked milestone for each calendar year, preserving date precision, jurisdiction, significance, and non-clickable source provenance.</p></div><Link href="/history/archive" className="editorial-card group p-8"><span className="eyebrow text-gold">17 verified records</span><h3 className="mt-4 font-display text-3xl text-ivory group-hover:text-gold-light">Open the year-by-year archive</h3><span className="mt-7 inline-flex items-center gap-2 text-sm text-gold-light">Browse 2010–2026 <ArrowRight className="h-4 w-4" /></span></Link></div></section>
