...
const items = [
  ...
  { id: "archive", category: "Research", title: "The evidence room", image: EXPANDED_IMAGES.galleryArchive, alt: "Editorial illustration of conserved dossiers, mechanical diagrams, film negatives, and archival tools", caption: "A conceptual research archive representing the source trails behind CasinooVerse history, game education, and daily reporting." },
];
