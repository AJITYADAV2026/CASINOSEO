...
export default function Articles() {
  ...
  return (
    <>
      ...
      <section className="section-pad bg-felt-deep"><div className="container grid gap-8 lg:grid-cols-[1fr_360px] lg:items-end"><div><p className="eyebrow text-gold">Historical context</p><h2 className="mt-3 max-w-4xl font-display text-5xl leading-tight text-ivory">Current Blog reporting sits on a verified 2010–2026 baseline.</h2><p className="mt-5 max-w-3xl leading-8 text-ivory/60">Use the year-by-year archive to place today’s regulation, operating technology, destinations, and harm-prevention debates in a dated record.</p></div><Link href="/history/archive" className="research-method-card group"><span className="eyebrow text-gold">17 years · 17 records</span><h3 className="mt-4 font-display text-3xl text-ivory group-hover:text-gold-light">Open the historical archive</h3><span className="mt-7 inline-flex text-sm text-gold-light">Browse 2010–3 September 2026 →</span></Link></div></section>
